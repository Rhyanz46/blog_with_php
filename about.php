...
<body>
    ...
    <!-- Banner Area Starts -->
    <section class="banner-area banner-area2 text-center" style="background-image: url('admin/img/about/<?php echo $about_gambar ?>') !important">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1><i><?php echo $about_judul ?></i></h1>
                    <p class="pt-2"><i><?php echo $about_deskripsi ?></i></p>
                </div>
            </div>
        </div>
    </section>
