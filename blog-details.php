...
$id = $_GET['id'];
$sql = "SELECT * FROM post_list WHERE id='$id'";
...
// console_log($data[0]['judul']);
// $id = $data[0]["id"];
$post = $data[0]["deskripsi"];
$kategori = $data[0]["kategori"];
$judul = $data[0]["nama"];
$views = $data[0]["views"];
$views = $views+1;

$sql = "UPDATE post_list SET views='$views' WHERE id='$id'";
mysqli_query($koneksidb, $sql)or die(mysql_error);
console_log($data);
...
<head>
    ...
    <!-- Page Title -->
    <title>Blog Details | <?php echo $views ?></title>
...
<body>
                ...
                <div class="col-lg-10">
                    ...
                    <div class="main-menu main-menu2">
                        ...
                        <li class="active"><a href="index.php">home</a></li>
                            <li><a href="menu.html">Tim Kami</a></li>
    ...
    <section class="banner-area banner-area2 blog-page text-center">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1><i><?php echo $judul ?></i></h1>
                    <a href="index.php">home</a>
                    <span class="mx-2">/</span>
                    <a href="blog-details.html"><?php echo $kategori ?></a>
                </div>
            </div>
        </div>
    </section>
